...
public class IntroduceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_video_learn_introduce, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        WebView webViewOne = getActivity().findViewById(R.id.webViewOne);

        webViewOne.getSettings().setJavaScriptEnabled(true);
        webViewOne.setWebViewClient(new WebViewClient());
        webViewOne.loadUrl("http://xgcs.metm.9mededu.com/onlineClassDesc?id=383");
    }
}